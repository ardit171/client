    ...
    def send(self, pyautogui, text):
        ...
        for a in text:
            ...
            if random.random() < self.correction and isError:
                # fix error
                self.sendTextOneByOne(pyautogui, true, send = "recursive")
                sleep(self.getDelay())
                isError = False
                true = ""
        ...
        if isError:
            self.sendTextOneByOne(pyautogui, true)
    
    def sendTextOneByOne(self, pyautogui, text, send = "all"):
